    ...
    <main class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link active" href="#">Array Functions</a>
                ...
                <hr>
                <h1 class="text-center">Array Functions</h1>
                <div class="col-8 offset-2">
                    <h4>EL array es: </h4>
                    <p>array('Ana', 'Juan', 'Pedro', 'Maria', 'Esteban', 'Luis', 'Jose', 'Alejandro')</p>
                    <h4>Con funcion Asort: </h4>
                    <?php
                        include '../exercises/arrayFunctions.php';

                        $array = arrayFunctions();
                        showAsort($array);
                    ?>
                    <h4>Con funcion Arsort: </h4>
                    <?php
                        showArsort($array);
                    ?>
                </div>
