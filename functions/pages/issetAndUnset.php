    ...
    <main class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link active" href="#">Isset and Unset</a>
                ...
                <hr>
                <h1 class="text-center">Isset and Unset</h1>
                <div class="col-8 offset-2">
                    <?php
                        include_once '../exercises/issetAndUnset.php';
